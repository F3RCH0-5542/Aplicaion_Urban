...
class ChicagoPage extends StatefulWidget {
  const ChicagoPage({super.key});

  @override
  State<ChicagoPage> createState() => _ChicagoPageState();
}
...
class _ChicagoPageState extends State<ChicagoPage> {
  ...
  static const String _descNewEra        = 'Gorra New Era 59FIFTY de la colección NBA Classic.';
  ...
  // ✅ Constantes de nombres de equipos del nav (SonarQube)
  ...
  final List<Map<String, dynamic>> productos = [
    {'id': 2,  'nombre': _teamName,                    'precio': 95000, 'imagen': 'assets/img/Bulls/1.png',                    'desc': _descNewEra},
    {'id': 3,  'nombre': '$_teamName Black',           'precio': 92000, 'imagen': 'assets/img/Bulls/2-removebg-preview.png',   'desc': _descLogoBordado},
    {'id': 4,  'nombre': '$_teamName Logo',            'precio': 98000, 'imagen': 'assets/img/Bulls/3.png',                    'desc': _descModeloClasico},
    {'id': 5,  'nombre': '$_teamName Red',             'precio': 95000, 'imagen': 'assets/img/Bulls/4-removebg-preview.png',   'desc': _descMultiColor},
    {'id': 6,  'nombre': '$_teamName Blue Ice',        'precio': 92000, 'imagen': 'assets/img/Bulls/5-removebg-preview.png',   'desc': _descLogoBordado},
    {'id': 7,  'nombre': '$_teamName Hormada',         'precio': 98000, 'imagen': 'assets/img/Bulls/6.png',                    'desc': _descModeloClasico},
    {'id': 8,  'nombre': '$_teamName Beige',           'precio': 95000, 'imagen': 'assets/img/Bulls/7-removebg-preview.png',   'desc': _descNewEra},
    {'id': 9,  'nombre': 'Chicago Blue',               'precio': 92000, 'imagen': 'assets/img/Bulls/8-removebg-preview.png',   'desc': _descLogoBordado},
    {'id': 10, 'nombre': '$_teamName Beige Hormada',   'precio': 98000, 'imagen': 'assets/img/Bulls/9-removebg-preview.png',   'desc': _descModeloClasico},
  ];
  ...
  Widget _buildDesktopAppBar() {
    ...
    return Row(children: [
      ...
      _buildNavMenu('NBA', [
        _buildNavMenuItem(_teamName,             _routeChicago),
    ...
    return Drawer(
      ...
      child: ListView(padding: EdgeInsets.zero, children: [
        ...
        _buildDrawerSection('NBA', [
          _buildDrawerItem(_teamName,             Icons.sports_basketball, _routeChicago),
  ...
  Widget _buildHeroImage() {
    return Container(
        ...
        child: ClipRect(child: Image.asset('assets/img/chi4.jpg',
  ...
  Widget _buildProductSection(bool isMobile) {
    return Container(
      ...
      child: Column(children: [
        ...
        Text('$_teamName se volvieron un ícono mundial gracias a su éxito y a Michael Jordan, considerado por muchos el mejor jugador de la historia.',
