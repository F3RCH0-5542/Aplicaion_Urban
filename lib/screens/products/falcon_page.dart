...
class FalconPage extends StatefulWidget {
  const FalconPage({super.key});

  @override
  State<FalconPage> createState() => _FalconPageState();
}

class _FalconPageState extends State<FalconPage> {
  // ✅ Constantes para evitar literales duplicados (SonarQube)
  static const String _teamName = 'Atlanta Falcons';
  ...
  final List<Map<String, dynamic>> productos = [
    {'id': 29, 'nombre': '$_teamName Classic',      'precio': 95000, 'imagen': 'assets/img/atlanta/10517894_1-removebg-preview.png',          'desc': 'Diseño clásico en negro con visera recta y escudo frontal bordado.'},
    {'id': 30, 'nombre': '$_teamName Black',        'precio': 92000, 'imagen': 'assets/img/atlanta/ATL-removebg-preview.png',                  'desc': 'Gorra negra con detalles en rojo y logotipo frontal en alto relieve.'},
    {'id': 31, 'nombre': '$_teamName Logo',         'precio': 98000, 'imagen': 'assets/img/atlanta/0ac1e7f183016ec72c3de6715c4a0e2a-removebg-preview.png', 'desc': 'Modelo oscuro con bordado oficial y bandera lateral.'},
    {'id': 32, 'nombre': 'Falcons Blanca Tricolor', 'precio': 95000, 'imagen': 'assets/img/atlanta/images-removebg-preview.png',               'desc': 'Blanca con visera negra y detalles en rojo.'},
    {'id': 33, 'nombre': 'Falcons Azul Hielo',      'precio': 92000, 'imagen': 'assets/img/atlanta/10517894_1-removebg-preview.png',           'desc': 'Tonos azul grisáceo con estilo moderno y escudo clásico.'},
    {'id': 34, 'nombre': 'Falcons Roja Curva',      'precio': 98000, 'imagen': 'assets/img/atlanta/images__2_-removebg-preview.png',           'desc': 'Roja con visera curva y diseño deportivo.'},
    {'id': 35, 'nombre': 'Falcons Roja Clásica',    'precio': 95000, 'imagen': 'assets/img/atlanta/atlantafalcoms2-removebg-preview.png',      'desc': 'Negra con visera roja y bordado frontal en blanco.'},
    {'id': 36, 'nombre': 'Falcons Blanca con Rojo', 'precio': 92000, 'imagen': 'assets/img/atlanta/negraroja-removebg-preview.png',            'desc': 'Panel frontal blanco, visera gris y detalles en rojo.'},
    {'id': 37, 'nombre': 'Falcons Gris Hormada',    'precio': 98000, 'imagen': 'assets/img/atlanta/rojaynegra-removebg-preview.png',           'desc': 'Gris texturizada con logo bordado y estructura firme.'},
  ];
  ...
  Widget _buildDesktopAppBar() {
    ...
    return Row(children: [
      ...
      _buildNavMenu('NFL', [
        _buildNavMenuItem(_teamName,             _routeFalcon),
    ...
    return Drawer(
      ...
      child: ListView(padding: EdgeInsets.zero, children: [
        ...
        _buildDrawerSection('NFL', [
          _buildDrawerItem(_teamName,             Icons.sports_football, _routeFalcon),
  ...
  Widget _buildHeroImage() {
    return Container(
        ...
        child: ClipRect(child: Image.asset('assets/img/falconw.jpg',
  ...
  Widget _buildProductSection(bool isMobile) {
    return Container(
      ...
      child: Column(children: [
        ...
        Text('Los $_teamName se han convertido en un símbolo del fútbol americano gracias a su garra, historia y pasión en el campo.',
