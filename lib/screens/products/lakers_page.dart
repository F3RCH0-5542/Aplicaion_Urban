...
class _LakersPageState extends State<LakersPage> {
  final List<Map<String, dynamic>> productos = [
    {
      ...
      'precio': 95000,
      'imagen': 'assets/img/Lakers/2-removebg-preview.png',
      'desc':
          'Gorra New Era 59FIFTY de la colección NBA Classic de Los Angeles Lakers.'
    },
    {
      'id': 21,
      'nombre': 'Lakers Black',
      'precio': 92000,
      'imagen': 'assets/img/Lakers/1-removebg-preview.png',
    ...
    },
    {
      ...
      'nombre': 'Lakers Logo',
      'precio': 98000,
      'imagen': 'assets/img/Lakers/3-removebg-preview.png',
      'desc':
          'Modelo oficial de los Lakers con detalles clásicos y bordado icónico.'
    },
    {
      'id': 23,
      'nombre': 'Lakers Edition 1',
      'precio': 95000,
      'imagen': 'assets/img/Lakers/4-removebg-preview.png',
    ...
    },
    {
      ...
      'precio': 92000,
      'imagen': 'assets/img/Lakers/5-removebg-preview.png',
    ...
    },
    {
      ...
      'precio': 98000,
      'imagen': 'assets/img/Lakers/6-removebg-preview.png',
      'desc':
          'Modelo clásico de Los Angeles Lakers con detalles bordados oficiales.'
    },
    {
      'id': 26,
      'nombre': 'Lakers Edition 4',
      'precio': 95000,
      'imagen': 'assets/img/Lakers/7-removebg-preview.png',
      'desc':
          'Gorra New Era oficial de la colección NBA Classic de Los Angeles Lakers.'
    },
    {
      'id': 27,
      'nombre': 'Lakers Edition 5',
      'precio': 92000,
      'imagen': 'assets/img/Lakers/8-removebg-preview.png',
    ...
    },
    {
      ...
      'precio': 98000,
      'imagen': 'assets/img/Lakers/9-removebg-preview.png',
    ...
    return Drawer(
      ...
      child: ListView(
        ...
        children: [
          ...
          const Divider(color: Color(0xFF2a2a2a)), // ListTile
          const Divider(color: Color(0xFF2a2a2a)),
          if (authProvider.isLoggedIn) ...[
            if (authProvider.isAdmin)
              ListTile(
  ...
  Widget _buildHeroImage() {
    return SizedBox(
        ...
        child: Image.asset('assets/img/lakers13.webp',
            fit: BoxFit.cover,
            errorBuilder: (_, __, ___) => Container(
                decoration: const BoxDecoration(
                    gradient: LinearGradient(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
              'Los Angeles Lakers son uno de los equipos más icónicos de toda la NBA. Tienen millones de fans en el mundo por su historia llena de títulos, leyendas como Kobe Bryant, Magic Johnson y ahora LeBron James. Por eso hay tantas gorras de los Lakers: no solo son parte del deporte, también son moda, cultura y actitud. Llevar una gorra de los Lakers es llevar la vibra de Los Ángeles.',
                ...
                SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFF552583),
