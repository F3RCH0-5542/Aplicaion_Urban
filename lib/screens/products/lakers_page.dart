...
class LakersPage extends StatefulWidget {
  const LakersPage({super.key});

  @override
  State<LakersPage> createState() => _LakersPageState();
}

class _LakersPageState extends State<LakersPage> {
  // ✅ Constantes para evitar literales duplicados (SonarQube)
  static const String _teamName = 'Los Angeles Lakers';
  ...
  final List<Map<String, dynamic>> productos = [
    {'id': 20, 'nombre': 'Lakers Classic',   'precio': 95000, 'imagen': 'assets/img/Lakers/2-removebg-preview.png', 'desc': 'Gorra New Era 59FIFTY de la colección NBA Classic de $_teamName.'},
    {'id': 21, 'nombre': 'Lakers Black',     'precio': 92000, 'imagen': 'assets/img/Lakers/1-removebg-preview.png', 'desc': 'Gorra de los Lakers en color negro con logotipo bordado premium.'},
    {'id': 22, 'nombre': 'Lakers Logo',      'precio': 98000, 'imagen': 'assets/img/Lakers/3-removebg-preview.png', 'desc': 'Modelo oficial de los Lakers con detalles clásicos y bordado icónico.'},
    {'id': 23, 'nombre': 'Lakers Edition 1', 'precio': 95000, 'imagen': 'assets/img/Lakers/4-removebg-preview.png', 'desc': 'Gorra oficial de $_teamName con diseño clásico New Era.'},
    {'id': 24, 'nombre': 'Lakers Edition 2', 'precio': 92000, 'imagen': 'assets/img/Lakers/5-removebg-preview.png', 'desc': 'Gorra New Era de los Lakers con bordado premium.'},
    {'id': 25, 'nombre': 'Lakers Edition 3', 'precio': 98000, 'imagen': 'assets/img/Lakers/6-removebg-preview.png', 'desc': 'Modelo clásico de $_teamName con detalles bordados oficiales.'},
    {'id': 26, 'nombre': 'Lakers Edition 4', 'precio': 95000, 'imagen': 'assets/img/Lakers/7-removebg-preview.png', 'desc': 'Gorra New Era oficial de la colección NBA Classic de $_teamName.'},
    {'id': 27, 'nombre': 'Lakers Edition 5', 'precio': 92000, 'imagen': 'assets/img/Lakers/8-removebg-preview.png', 'desc': 'Gorra premium de $_teamName con acabado de alta calidad.'},
    {'id': 28, 'nombre': 'Lakers Edition 6', 'precio': 98000, 'imagen': 'assets/img/Lakers/9-removebg-preview.png', 'desc': 'Modelo exclusivo de los Lakers con detalles bordados icónicos.'},
  ];
  ...
  Widget _buildDesktopAppBar() {
    ...
    return Row(children: [
      ...
      _buildNavMenu('NBA', [
        ...
        _buildNavMenuItem(_teamName,          _routeLakers),
      ]),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          gradient: LinearGradient(colors: [
            ...
            const Color(0xFF552583).withOpacity(0.3),
          ]),
    ...
    return Drawer(
      ...
      child: ListView(padding: EdgeInsets.zero, children: [
        DrawerHeader(
            decoration: const BoxDecoration(
                gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight,
                    colors: [Color(0xFFFFD700), Color(0xFF552583)])),
        ...
        _buildDrawerSection('NBA', [
          ...
          _buildDrawerItem(_teamName,          Icons.sports_basketball, _routeLakers),
        ]),
        ...
        _buildDrawerSection('MLB', [
          _buildDrawerItem(_teamBostonRedSox,    Icons.sports_baseball, _routeRed),
  ...
  Widget _buildHeroImage() {
    return SizedBox(
        ...
        child: Image.asset('assets/img/lakers13.webp', fit: BoxFit.cover,
            errorBuilder: (_, __, ___) => Container(
                decoration: const BoxDecoration(
                    gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter,
                        colors: [Color(0xFF552583), Colors.black])),
                child: const Center(child: Icon(Icons.sports_basketball, size: 100, color: Colors.white54)))));
  }
  ...
  Widget _buildProductSection(bool isMobile) {
    return Container(
      ...
      child: Column(children: [
        ...
        Text('$_teamName son uno de los equipos más icónicos de toda la NBA. Tienen millones de fans en el mundo por su historia llena de títulos, leyendas como Kobe Bryant, Magic Johnson y ahora LeBron James.',
            ...
            SizedBox(
                ...
                child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xFF552583), foregroundColor: Colors.white,
