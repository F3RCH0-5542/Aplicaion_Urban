...
class _VegasPageState extends State<VegasPage> {
  final List<Map<String, dynamic>> productos = [
    {
      'id': 47,
      'nombre': 'Vegas Raid Clásica Blanca',
      'precio': 95000,
      'imagen': 'assets/img/vegas/blanca-removebg-preview.png',
      'desc': 'Blanca con visera plana y escudo frontal bordado.'
    },
    {
      'id': 48,
      'nombre': 'Vegas Raid Black',
      'precio': 92000,
      'imagen': 'assets/img/vegas/negra-removebg-preview.png',
      'desc': 'Negra con detalles en plata y logotipo frontal en alto relieve.'
    },
    {
      'id': 49,
      'nombre': 'Vegas Raid Premium Blanca',
      'precio': 98000,
      'imagen': 'assets/img/vegas/blancaconnegra-removebg-preview.png',
      'desc': 'Blanca con detalles en negro y logo bordado en alto relieve.'
    },
    {
      'id': 50,
      'nombre': 'Vegas Raid Negra y Blanca',
      'precio': 95000,
      'imagen': 'assets/img/vegas/bonita-removebg-preview (1).png',
      'desc': 'Negra con panel blanco y bandera lateral bordada.'
    },
    {
      'id': 51,
      'nombre': 'Vegas Raid Tricolor',
      'precio': 92000,
      'imagen': 'assets/img/vegas/comogris-removebg-preview.png',
      'desc': 'Negra con visera blanca y detalles modernos.'
    },
    {
      'id': 52,
      'nombre': 'Vegas Raid Letras Edition',
      'precio': 98000,
      'imagen': 'assets/img/vegas/letras-removebg-preview.png',
      'desc': 'Diseño moderno con letras destacadas y escudo clásico.'
    },
    {
      'id': 53,
      'nombre': 'Vegas Raid Logo White',
      'precio': 95000,
      'imagen': 'assets/img/vegas/blancalogo-removebg-preview.png',
      'desc': 'Blanca con visera plana y bordado frontal destacado.'
    },
    {
      'id': 54,
      'nombre': 'Vegas Raid Triple X',
      'precio': 92000,
      'imagen': 'assets/img/vegas/3x-removebg-preview.png',
      'desc': 'Panel frontal blanco con visera gris y detalles modernos.'
    },
    {
      'id': 55,
      'nombre': 'Vegas Raid Yellow Edition',
      'precio': 98000,
      'imagen': 'assets/img/vegas/amarillo-removebg-preview.png',
      'desc': 'Edición especial con detalles dorados y estructura firme.'
    },
  ];
  ...
  Widget _buildHeroImage() {
    return SizedBox(
        ...
        child: Image.asset('assets/img/vegas/raiders-logo-wazxzw84pfd1a499.jpg',
            fit: BoxFit.cover,
            errorBuilder: (_, __, ___) => Container(
                decoration: BoxDecoration(
                    gradient: LinearGradient(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
              'Los Las Vegas Raiders son sinónimo de rebeldía, pasión y un legado de éxito en la NFL. Con su icónico logo de pirata, el equipo representa una mentalidad audaz y un estilo que se ha convertido en un emblema global de la cultura urbana.',
