...
class _WhitePageState extends State<WhitePage> {
  final List<Map<String, dynamic>> productos = [
    {
      ...
      'precio': 95000,
      'imagen': 'assets/img/Sox/1-removebg-preview.png',
      'desc': 'Gorra New Era 59FIFTY de la colección MLB Classic.'
    },
    {
      'id': 66,
      'nombre': 'Chicago White Sox – Eternal Pride',
      'precio': 92000,
      'imagen': 'assets/img/Sox/2-removebg-preview.png',
    ...
    },
    {
      ...
      'precio': 98000,
      'imagen': 'assets/img/Sox/3-removebg-preview.png',
    ...
    },
    {
      ...
      'precio': 95000,
      'imagen': 'assets/img/Sox/4-removebg-preview.png',
      'desc': 'Gorra New Era con diseño icónico del equipo.'
    },
    {
      'id': 69,
      'nombre': 'Chicago White Sox – Black and White Style',
      'precio': 92000,
      'imagen': 'assets/img/Sox/5-removebg-preview.png',
      'desc': 'Gorra con logotipo bordado y diseño premium.'
    },
    {
      'id': 70,
      ...
      'precio': 98000,
      'imagen': 'assets/img/Sox/6-removebg-preview.png',
      'desc': 'Modelo clásico con detalles bordados oficiales.'
    },
    {
      'id': 71,
      ...
      'precio': 95000,
      'imagen': 'assets/img/Sox/7-removebg-preview.png',
      'desc': 'Gorra New Era de la colección MLB Classic.'
    },
    {
      'id': 72,
      'nombre': 'Chicago White Sox – Baseball Passion',
      'precio': 92000,
      'imagen': 'assets/img/Sox/8-removebg-preview.png',
      'desc': 'Gorra con logotipo bordado y diseño premium.'
    },
    {
      'id': 73,
      ...
      'precio': 98000,
      'imagen': 'assets/img/Sox/9-removebg-preview.png',
      'desc': 'Modelo clásico con detalles bordados oficiales.'
    },
  ];
  ...
  Widget _buildHeroImage() {
    return SizedBox(
        ...
        child: Image.asset('assets/img/Sox/Wall.jpg',
            fit: BoxFit.cover,
            errorBuilder: (_, __, ___) => Container(
                decoration: BoxDecoration(
                    gradient: LinearGradient(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
              'Los Chicago White Sox tienen gorras porque representan la pasión, historia y orgullo del béisbol en el lado sur de Chicago. Estas gorras no solo muestran apoyo al equipo, también son un símbolo de identidad urbana, estilo callejero y tradición deportiva que ha pasado de generación en generación.',
