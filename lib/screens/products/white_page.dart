...
class _WhitePageState extends State<WhitePage> {
  ...
  static const String _teamName          = 'Chicago White Sox';
  ...
  final List<Map<String, dynamic>> productos = [
    {'id': 65, 'nombre': '$_teamName – Shadow of the South',    'precio': 95000, 'imagen': 'assets/img/Sox/1-removebg-preview.png', 'desc': 'Gorra New Era 59FIFTY de la colección MLB Classic.'},
    {'id': 66, 'nombre': '$_teamName – Eternal Pride',          'precio': 92000, 'imagen': 'assets/img/Sox/2-removebg-preview.png', 'desc': _descLogoBordado},
    {'id': 67, 'nombre': '$_teamName – Diamond Spirit',         'precio': 98000, 'imagen': 'assets/img/Sox/3-removebg-preview.png', 'desc': _descModeloClasico},
    {'id': 68, 'nombre': '$_teamName – Chicago Classic',        'precio': 95000, 'imagen': 'assets/img/Sox/4-removebg-preview.png', 'desc': 'Gorra New Era con diseño icónico del equipo.'},
    {'id': 69, 'nombre': '$_teamName – Black and White Style',  'precio': 92000, 'imagen': 'assets/img/Sox/5-removebg-preview.png', 'desc': _descLogoBordado},
    {'id': 70, 'nombre': '$_teamName – South Side Power',       'precio': 98000, 'imagen': 'assets/img/Sox/6-removebg-preview.png', 'desc': _descModeloClasico},
    {'id': 71, 'nombre': '$_teamName – Legendary Tradition',    'precio': 95000, 'imagen': 'assets/img/Sox/7-removebg-preview.png', 'desc': 'Gorra New Era de la colección MLB Classic.'},
    {'id': 72, 'nombre': '$_teamName – Baseball Passion',       'precio': 92000, 'imagen': 'assets/img/Sox/8-removebg-preview.png', 'desc': _descLogoBordado},
    {'id': 73, 'nombre': '$_teamName – Urban Force',            'precio': 98000, 'imagen': 'assets/img/Sox/9-removebg-preview.png', 'desc': _descModeloClasico},
  ];
  ...
  Widget _buildDesktopAppBar() {
    ...
    return Row(children: [
      ...
      _buildNavMenu('MLB', [
        ...
        _buildNavMenuItem(_teamName,         _routeWhite),
    ...
    return Drawer(
      ...
      child: ListView(padding: EdgeInsets.zero, children: [
        ...
        _buildDrawerSection('MLB', [
          ...
          _buildDrawerItem(_teamName,          Icons.sports_baseball, _routeWhite),
  ...
  Widget _buildHeroImage() {
    return SizedBox(
        ...
        child: Image.asset('assets/img/Sox/Wall.jpg', fit: BoxFit.cover,
            errorBuilder: (_, __, ___) => Container(
                decoration: BoxDecoration(
  ...
  Widget _buildProductSection(bool isMobile) {
    return Container(
      ...
      child: Column(children: [
        ...
        Text('Los $_teamName tienen gorras porque representan la pasión, historia y orgullo del béisbol en el lado sur de Chicago. Estas gorras no solo muestran apoyo al equipo, también son un símbolo de identidad urbana, estilo callejero y tradición deportiva.',
